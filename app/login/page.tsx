...
export default function Login() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      if (result.user) {
        // Redirect to a dashboard or show success
  ...
  return (
    <div className="min-h-screen bg-brand-black text-white flex flex-col justify-center relative overflow-hidden">
      {/* Background Glows */}
      ...
      <div className="w-full max-w-md mx-auto px-6 relative z-10">
        ...
        >
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white text-black px-6 py-4 rounded-xl font-bold hover:bg-gray-200 transition-colors disabled:opacity-50"
          >
            {loading ? (
